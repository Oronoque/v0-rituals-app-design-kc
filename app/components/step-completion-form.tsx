      ...
      <div className="flex-1 overflow-y-auto p-4 pb-24">
        ...
        <Card className="mb-6 bg-[#2C2C2E] border-[#3C3C3E]">
          <CardContent className="p-4">
            ...
            <Progress 
              value={progress} 
              className="w-full h-2 bg-[#3C3C3E]"
            />
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  {currentStep.type === 'boolean' && (
                    <div>
                      <label className="text-white text-sm">Mark as completed</label>
                      <Button
                        onClick={() => handleStepComplete(currentStepIndex, { completed: true })}
                  ...
                  {currentStep.type === 'qna' && (
                    <div>
                      <label className="text-white text-sm">Your response</label>
                      <Textarea
                  ...
                  {currentStep.type === 'exercise_set' && (
                    <ExerciseSetCompletion
                      ...
                      onComplete={(completion) => handleStepComplete(currentStepIndex, completion)}
                    />
                  )}

                  {(currentStep.type === 'counter' || currentStep.type === 'scale' || currentStep.type === 'timer') && (
                    <div>
                      <label className="text-white text-sm">Mark as completed</label>
                      <Button
                        onClick={() => handleStepComplete(currentStepIndex, { completed: true })}
  ...
  return (
    <div className="space-y-4">
      <div className="text-center">
        <h3 className="text-white font-medium">{step.config?.exercise?.name || step.name}</h3>
