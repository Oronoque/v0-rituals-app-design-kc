...
export function ReflectionScreen({
  ...
  const totalSteps = completedRituals.reduce(
    (sum, ritual) => sum + ritual.step_definitions.length,
    0
  );
  const completedSteps = completedRituals.reduce(
    (sum, ritual) =>
      sum + ritual.step_definitions.filter((step) => step.is_required).length,
    0
  );
  ...
  useEffect(() => {
    const generateAnalysis = async () => {
      ...
      const analysis = generateJungianAnalysis(
        completedRituals,
        dayRating,
        dayReflection,
        completionRate
      ...
      <div className="p-4 border-b border-gray-700">
        <div className="ios-card p-4">
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            ...
            <div className="text-center">
              <div className="text-ios-title-2 font-bold text-blue-400">
          ...
          {dayReflection && (
            <div className="bg-[#2C2C2E] rounded-lg p-3">
              <h4 className="text-white font-medium text-ios-subhead mb-2">
                Your Reflection
              </h4>
              <p className="text-[#AEAEB2] text-ios-subhead leading-relaxed">
                {dayReflection}
              </p>
            </div>
          )}
            ...
            {isGenerating ? (
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-purple-400 text-ios-subhead">
                    Analyzing your day...
                  </span>
                </div>
              ...
              <div className="space-y-4">
                <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-white text-ios-subhead leading-relaxed">
                      {aiAnalysis}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    {completionRate >= 80 && dayRating <= 2 && (
                      <div className="flex items-start space-x-3 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                        ...
                        <div>
                          ...
                          <div className="text-[#AEAEB2] text-ios-footnote">
                            High completion but low satisfaction suggests a need
                    ...
                    {completionRate < 60 && dayRating >= 4 && (
                      <div className="flex items-start space-x-3 p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                        ...
                        <div>
                          <div className="text-green-400 font-medium text-ios-footnote">
                            Intuitive Wisdom
                          </div>
                          <div className="text-[#AEAEB2] text-ios-footnote">
                            You found satisfaction beyond task completion -
                    ...
                    {completionRate >= 80 && dayRating >= 4 && (
                      <div className="flex items-start space-x-3 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                        ...
                        <div>
                          <div className="text-blue-400 font-medium text-ios-footnote">
                            Aligned Day
                          </div>
                          <div className="text-[#AEAEB2] text-ios-footnote">
                        ...
                        <div className="flex justify-start">
                          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-3">
                            <div className="flex items-center space-x-2">
                              ...
                              />
                              <span className="text-purple-400 text-ios-footnote ml-2">
                                Reflecting...
                              </span>
                            </div>
                          </div>
